...
public class CostumersMapper {
	...
	public CostumersBaseDTO toCostumersBaseDTO (Costumers costumers) {
		return modelMapper.map(costumers, CostumersBaseDTO.class);
	}
	
	public CostumersDTO toCostumersDTO (Costumers costumers) {
		return modelMapper.map(costumers, CostumersDTO.class);
	}
